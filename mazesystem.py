...
class Maze2D:
    def __init__(self,xyshape,res=10,padding=30,line_width=1,bg="light grey",ani_walls=False,ani_cells=False,start=None,end=None,draw_explore=True,show_text=True):
        """
...
class Navigation:
    ...
    def draw_start_end(self):
        ...
        self.maze.graphic.draw_on_cell(self.start,"circle","red",permanent=True,prop=.9)
        self.maze.graphic.draw_on_cell(self.end,"circle","green",permanent=True,prop=.9) 
    ...
    def draw_explore_path(self,c1,c2,linecolor,width,override=False):
